...
use Illuminate\Http\Request; //mendapatkan inputan dari form

use App\User; //memanggil class Model User

use Validator; //memanggil facade class Validator{}
...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //Has Password
        //bcrypt = untuk mengacak password
